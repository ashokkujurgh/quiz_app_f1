...
mixin _$Message {
  ...
  String get createdAt =>
      throw _privateConstructorUsedError; // Client-only field for optimistic-send reconciliation, never sent to
...
class _$MessageImpl implements _Message {
  const _$MessageImpl({
    ...
    this.text,
    this.imageUrl,
    final List<String> readBy = const <String>[],
  ...
  @override
  String toString() {
    return 'Message(id: $id, conversationId: $conversationId, senderId: $senderId, text: $text, imageUrl: $imageUrl, readBy: $readBy, createdAt: $createdAt, clientTempId: $clientTempId)';
  }
...
abstract class _Message implements Message {
  ...
  List<String> get readBy;
  @override
  String get createdAt; // Client-only field for optimistic-send reconciliation, never sent to
  // or received verbatim from the server.
  @override
